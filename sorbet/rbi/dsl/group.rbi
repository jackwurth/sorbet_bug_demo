...
class Group
  ...
  module CommonRelationMethods
    ...
    sig { params(limit: NilClass).returns(T.nilable(::Group)) }
  ...
  module GeneratedAssociationMethods
    ...
    def build_parent_group(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::Group) }
    def create_parent_group(*args, &blk); end
    ...
    # This method is created by ActiveRecord on the `Group` class because it declared `has_many :members`.
    ...
    sig { returns(T.nilable(::Group)) }
    def parent_group; end

    sig { params(value: T.nilable(::Group)).void }
    def parent_group=(value); end

    sig { returns(T.nilable(::Group)) }
    def reload_parent_group; end

    sig { returns(T::Array[T.untyped]) }
    def sub_group_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def sub_group_ids=(ids); end

    # This method is created by ActiveRecord on the `Group` class because it declared `has_many :sub_groups`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::Group::PrivateCollectionProxy) }
    def sub_groups; end

    sig { params(value: T::Enumerable[::Group]).void }
    def sub_groups=(value); end
  end
